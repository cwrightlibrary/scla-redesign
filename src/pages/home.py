...
with st.expander("Upcoming Events", expanded=True):
    ...
    events_table = [
        ("May 27, 2026", "[Public Library Section Meeting](https://www.scla.org/index.php?option=com_jevents&task=icalrepeat.detail&evid=209&Itemid=115&year=2026&month=05&day=27&title=public-library-section-meeting&uid=485083b4ecb959135f77a98f6dd79a6b)"),
        ("May 28, 2026", "[Library Marketing and Outreach Round Table Meeting](https://www.scla.org/index.php?option=com_jevents&task=icalrepeat.detail&evid=214&Itemid=115&year=2026&month=05&day=28&title=-library-marketing-and-outreach-round-table-meeting&uid=2bb76aa2661d88ac38315ed9a83fdcb9)"),
        ("July 23, 2026", "[Library Marketing and Outreach Round Table Meeting](https://www.scla.org/index.php?option=com_jevents&task=icalrepeat.detail&evid=215&Itemid=115&year=2026&month=07&day=23&title=-library-marketing-and-outreach-round-table-meeting&uid=612844cac4e4ce4f560082b52d7a0e26)"),
        ("August 19, 2026", "[Public Library Section Meeting](https://www.scla.org/index.php?option=com_jevents&task=icalrepeat.detail&evid=210&Itemid=115&year=2026&month=08&day=19&title=public-library-section-meeting&uid=1022c2f438a0a719547aaf5ec3e29bb8)"),
        ("September 24, 2026", "[Library Marketing and Outreach Round Table Meeting](https://www.scla.org/index.php?option=com_jevents&task=icalrepeat.detail&evid=216&Itemid=115&year=2026&month=09&day=24&title=-library-marketing-and-outreach-round-table-meeting&uid=f17bda716cf48af12b028b69e61d45cb)")
    ]
...
with st.expander("Announcements"):
    ...
    st.write(reg_text)
    st.link_button("Register Now", "https://docs.google.com/forms/d/e/1FAIpQLSdUDV3ndewvO0OkgMBXuMC277DILLNvVZNTGg1R6RkN0yRwNA/viewform?usp=header")

with st.expander("Support SCLA at Kroger"):
    st.header("Support SCLA at Kroger")
    st.write("SCLA is now part of the **Kroger Community Rewards Program!** Every time you shop at Kroger, you can support libraries across South Carolina at no extra cost to you.")
...
with st.expander("South Carolina Digital Library"):
    ...
    st.write("This [digital collection](https://digital.tcl.sc.edu/digital/collection/scla) curated by the South Carolina Digital Library showcases 100 years of SCLA history, including photographs, conference brochures, and publications.")

with st.expander("SCLA Continuing Education Webinars"):
    st.header("SCLA Continuing Education Webinars")

    st.write("View all previous webinars on the [SCLA YouTube channel](https://www.youtube.com/channel/UCES4xRifDCfuNX9W6GbV01w).")
    st.info(":material/info: To submit a webinar proposal, [visit this link](https://forms.gle/CXkeXHwbUcrtCg6A8).")
